...
class DetailInformation extends StatelessWidget {
  ...
  const DetailInformation({Key? key, required this.pengumumanDetail}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ButtonSection(),
              BannerInformation(),
              TitleInformation(pengumumanDetail: pengumumanDetail), // Kirim data pengumumanDetail ke widget TitleInformation
              BodyInformation(pengumumanDetail: pengumumanDetail), // Kirim data pengumumanDetail ke widget BodyInformation
            ],
          ),
        ),
      ),
